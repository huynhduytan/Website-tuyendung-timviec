  ...
  function readFileAsDataURL(file) {
      return $$1.Deferred(function (deferred) {
          $$1.extend(new FileReader(), {
              onload: function (e) {
                  var dataURL;
                  GetLinkImageCover(file, function (url) {
                      dataURL = url;
                      deferred.resolve(dataURL);
                  });
                  //var dataURL = "/Assets/admin/images/bg-1.jpg";
              },
      ...
      //return "/Assets/admin/images/bg-1.jpg";
  }
...
function GetLinkImageCover(btn, callback) {
    ...
    formData.append('file', btn);
    $.ajax({
        type: 'POST',
        url: '/NewManagement/UploadFileImageSumernote',
        contentType: false,
        processData: false,
        data: formData,
